...
update-fixtures: all
	@echo "Updating log-parser/fixtures/logs/since-until/*.json from audit.cborseq..."
	${TARGETDIR}/${PROFILE}/crau-query \
		-c log-parser/fixtures/conf/query.conf \
		--log-file log-parser/fixtures/logs/since-until/audit.cborseq \
		--boot-time 1771970837 \
		> log-parser/fixtures/logs/since-until/none.json
	${TARGETDIR}/${PROFILE}/crau-query \
		-c log-parser/fixtures/conf/query.conf \
		--log-file log-parser/fixtures/logs/since-until/audit.cborseq \
		--boot-time 1771970837 \
		--since "2026-02-25 08:13:23JST + 1 mins" \
		> log-parser/fixtures/logs/since-until/since.json
	${TARGETDIR}/${PROFILE}/crau-query \
		-c log-parser/fixtures/conf/query.conf \
		--log-file log-parser/fixtures/logs/since-until/audit.cborseq \
		--boot-time 1771970837 \
		...
		> log-parser/fixtures/logs/since-until/since-until.json
	${TARGETDIR}/${PROFILE}/crau-query \
		-c log-parser/fixtures/conf/query.conf \
		--log-file log-parser/fixtures/logs/since-until/audit.cborseq \
		--boot-time 1771970837 \
		--until "2026-02-25 08:13:23JST + 2 mins" \
		> log-parser/fixtures/logs/since-until/until.json
