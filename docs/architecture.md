...
crau-agent runs as a system service and receives cryptographic events
from the kernel through eBPF, and write them onto the primary log
file.
...
- Install BPF program to monitor when USDT events
